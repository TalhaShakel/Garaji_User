    ...
    body: Container(
      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            SizedBox(height: 20,),
            Text("GAREJI SHOP APP Privacy Policy",style: GoogleFonts.poppins(
            ...
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Posted: October 20, 2022",style: GoogleFonts.poppins(
            ...
            Padding(
              ...
              child: Text("GarejiShop App (Gareji Shop, “we” or “us”) has created this Privacy Policy in order to demonstrate our firm commitment to privacy. This Privacy Policy is hereby incorporated in our Term of Use and by registering for Services via the GarejiShop App, you accept the terms of this Privacy Policy. All capitalized terms not otherwise defined herein shall have the meanings given them in the Terms of Use.",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Notification of Changes",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
        Padding(
          ...
          child: Text("We may update this Privacy Policy from time to time as our services change and expand. If we update this Privacy Policy, we will post the updated Privacy Policy. Unless otherwise provided below, the revised Privacy Policy will take effect when it is posted. Once any changes become effective, your continued use of the GarejiShop App after such time will signify your acceptance of the new terms. If we are going to use your Personally Identifiable Information (PII) in a manner different from that stated at the time of collection, we will notify you, and you will have a choice as to whether or not we use your Personally Identifiable Information in such different manner. In addition, if we make any material changes in our privacy practices that affect user information already stored in our database, we will notify you of the change and solicit your express acceptance of that change.",style: GoogleFonts.poppins(
            ...
            Row(
              children: [
                Padding(
                  ...
                  child: Text("Information We Gather during Registration",style: GoogleFonts.poppins(
                      textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                  ),),
                ),
              ],
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("If you register an Account or apply to become a Technician, we collect and store information that specifically identifies you or your account (Personally Identifiable Information). At this time, the most information you would be required to submit is your first name, last name, password, street address, city, state, zip/postal code, country, phone number, email address, and information about your vehicle such as: license plate, VIN (Vehicle Identification Number), make, model, year, and engine size. Technician applicants will also be asked to provide information about their repair skills and abilities to perform Vehicle Services.Other information requested on our registration page, including the ability to receive promotional offers from us, is optional. We may, in the future, include other optional requests for information from you, to help us to tailor the GarejiShop App for you and deliver personalized information to you. We may supplement our information with additional information purchased from third parties for marketing purposes.",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                ...
                Text("How We Use Registration Information",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("Use of General Data",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("We reserve the right to use the general data it obtains from Users' use of the GarejiShop App, including all statistical information. You acknowledge that such data belongs to us and that we shall have the right to use such data as we determine in our sole discretion.",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                ...
                Text("Request for Deletion of Personal Data ",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            ...
            Row(
              children: [
                ...
                Text("Online Order Placement and Management",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            ...
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Online Surveys and Contests",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            ...
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Cookies and Automatically Gathered Information",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("We may use third-party Service Providers to monitor and analyze the use of our Service. Google Analytics is a web analytics service offered by Google that tracks and reports website traffic. Google uses the data collected to track and monitor the use of our Service. This data is shared with other Google services. Google may use the collected data to contextualize and personalize the ads of its own advertising network.You can opt-out of having made your activity on the Service available to Google Analytics by installing the Google Analytics opt-out browser add-on. The add-on prevents the Google Analytics JavaScript (ga.js, analytics.js, and dc.js) from sharing information with Google Analytics about visits activity. For more information on the privacy practices of Google, please visit the Google Privacy & Terms web page: https://policies.google.com/privacy?hl=en",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Technician Profile",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("As part of registration, Technicians may set up a Profile describing their experience, rates, and qualifications. Some of the information requested in the Profile registration is mandatory. If you decide to offer your services through GarejiShop App, this information may be used publicly. Potential Users will look to your Profile to help them decide whether to make use of your services.",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Technicians",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("Work orders placed on the GarejiShop App are completed by third-party Technicians. We may share the email addresses, phone numbers, or addresses of Users and Technicians once a project is awarded on our GarejiShop App to enable work on the project to be completed. These Technicians are not allowed to use Personally Identifiable Information except for the purpose of providing Vehicle Services.",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Third Party Partners",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            ...
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Comments and Feedback Submitted by Users",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            ...
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("We will use commercially reasonable methods to keep Personally Identifiable Information securely in our files and systems. We cannot, however, guarantee the security of your Personally Identifiable Information, particularly, as it travels over the Internet. As such, we encourage you to exercise caution in determining what information you disclose via the Internet.",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Terminating Your Account",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            ...
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Correcting/Updating Your Information and \nOpting Out",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("This GarejiShop App gives the following options for changing and modifying information previously provided. You may update your registration information using the appropriate tools in the GarejiShop navigation bar.For other requests, please contact: b.aviles@garejishop.com",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Transmittal of Data",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("We reserve the right to transmit into the United States any and all data that is submitted by Users outside the United States, including but not limited to Personally Identifiable Information, and you hereby expressly consent to the foregoing.",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Legal Disclaimer",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("Though we make every effort to preserve User privacy, we may need to disclose your Personally Identifiable Information when required by law, or when we have a good-faith belief that such action is necessary to comply with a current judicial proceeding, a court order, or legal process.",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            SizedBox(height: 10,),
            Row(
              children: [
                SizedBox(width: 8,),
                Text("Contacting Us",style: GoogleFonts.poppins(
                    textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500)
                ),),
              ],
            ),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: Text("If you have any questions about this Privacy Policy or our privacy practices, you may contact us at b.aviles@garejishop.com ",style: GoogleFonts.poppins(
                  textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.normal,fontSize: 12)
              ),),
            ),
            Row(
              ...
              children: [
                Padding(
                  ...
                  child: Text("UPDATED: OCTOBER 20, 2022",style: GoogleFonts.poppins(
                      textStyle: TextStyle(color: Colors.black,fontWeight: FontWeight.w500,)
                  ),),
                ),
              ],
